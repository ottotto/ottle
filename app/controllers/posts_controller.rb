class PostsController < ApplicationController
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:title, :description, :tag_list, :image, :avatar, :FromDate, :ToDate, :address, :latitude, :longitude, post_attachments_attributes: [:id, :post_id, :avatar])
    end
end
